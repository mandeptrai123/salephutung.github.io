...
ReactDOM.render(
  ...
  <Row>
    <Col sm={12} >
      <Nav variant="pills" className="justify-content-center sm-6"  fill={true} justify={true}>
        <Nav.Item>
          <Nav.Link eventKey="banhang">
            Bán Hàng
        ...
        <Nav.Item>
          ...
          <Nav.Link eventKey="thongbaohethang"><Badge variant="danger">9</Badge>Mặt Hàng Đang Hết</Nav.Link>
        </Nav.Item>
        <Nav.Item>
