...
function HangTonSLThap() {

    const [show, setShow] = useState(false);
    const [messLoading, setMessLoading] = useState("   Đang Làm Mới !");
    ...
    return(
        <section className='hang-container'>
            ...
            <h3 className='title'>Hàng Có Số Lượng Tồn Kho Thấp</h3>
            <FontAwesomeIcon   onClick={e=>{Refresh()}} color={'green'} size="4x" icon={faSyncAlt}/>
                <ul className='list-item__hang'>
                    <li className='item__hang'>
                ...
                <div className='note'>
                    <p>Khi nhập thêm hàng thông báo tự động xóa</p>
